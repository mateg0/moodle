 ...
 */
namespace mod_presentationfolder\content;
...
class exporter extends abstract_mod_exporter {
    ...
    /**
     * Get the exportable items for mod_presentationfolder.
     *
    ...
    public function get_exportables(bool $includeuserdata = false): array {
        ...
        $contentitems[]  = new exportable_filearea(
            $this->get_context(),
            $this->get_component(),
            get_string('presentationfoldercontent', 'mod_presentationfolder'),

            // The files held in mod_presentationfolder are stored in the 'content' filearea, under itemid 0.
            'content',
            0,
