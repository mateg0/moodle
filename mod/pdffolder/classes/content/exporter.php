 ...
 */
namespace mod_pdffolder\content;
...
class exporter extends abstract_mod_exporter {
    ...
    /**
     * Get the exportable items for mod_pdffolder.
     *
    ...
    public function get_exportables(bool $includeuserdata = false): array {
        ...
        $contentitems[]  = new exportable_filearea(
            $this->get_context(),
            $this->get_component(),
            get_string('pdffoldercontent', 'mod_pdffolder'),

            // The files held in mod_pdffolder are stored in the 'content' filearea, under itemid 0.
            'content',
            0,
