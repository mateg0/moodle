 ...
 */
namespace mod_textfolder\content;
...
class exporter extends abstract_mod_exporter {
    ...
    /**
     * Get the exportable items for mod_textfolder.
     *
    ...
    public function get_exportables(bool $includeuserdata = false): array {
        ...
        $contentitems[]  = new exportable_filearea(
            $this->get_context(),
            $this->get_component(),
            get_string('textfoldercontent', 'mod_textfolder'),

            // The files held in mod_textfolder are stored in the 'content' filearea, under itemid 0.
            'content',
            0,
