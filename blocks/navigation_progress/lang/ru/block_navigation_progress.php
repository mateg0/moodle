...
/**
 * Strings for component 'block_navigation_progress', language 'ru', version '1.0'.
 *
...
$string['completion_progress:addinstance'] = 'Добавлять новый блок «Ход курса»';
$string['completion_progress:myaddinstance'] = 'Добавлять блок «Ход курса» на Домашнюю страницу';
$string['completion_progress:overview'] = 'Просматривать обзор прогресса выполнения всеми студентами';
$string['completion_progress:showbar'] = 'Показывать панель в блоке «Ход курса»';
...
$string['config_default_title'] = 'Ход курса';
...
$string['no_blocks'] = 'Блоки «Ход курса» не установлены для ваших курсов.';
...
$string['privacy:metadata'] = 'Блок «Ход курса» только отображает существующие данные о завершении.';
$string['progress'] = 'Навигация';
$string['progressbar'] = 'Ход курса';
...
$string['why_set_the_title_help'] = '<p>Может быть несколько экземпляров блока «Ход курса». Вы можете использовать разные блоки «Ход курса» для отслеживания различных наборов элементов курса или ресурсов. Например, вы можете отслеживать ход выполнения заданий в одном блоке и тесты в другом. По этой причине вы можете заменить заголовок по умолчанию на более подходящий заголовок для каждого блока.</p>';
