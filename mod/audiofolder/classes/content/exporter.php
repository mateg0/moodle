 ...
 */
namespace mod_audiofolder\content;
...
class exporter extends abstract_mod_exporter {
    ...
    /**
     * Get the exportable items for mod_audiofolder.
     *
    ...
    public function get_exportables(bool $includeuserdata = false): array {
        ...
        $contentitems[]  = new exportable_filearea(
            $this->get_context(),
            $this->get_component(),
            get_string('audiofoldercontent', 'mod_audiofolder'),

            // The files held in mod_audiofolder are stored in the 'content' filearea, under itemid 0.
            'content',
            0,
