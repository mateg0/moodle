The Navigation Progress block is a time-management tool for students.
...
To Install
1. Copy the navigation_progress directory to the blocks/ directory of your Moodle instance
2. Visit the notifications page

For more information, visit...
http://docs.moodle.org/en/Installing_contributed_modules_or_plugins

Once the Navigation Progress block is installed, you can use it in a course as follows.
...
4. Add the Navigation Progress block to your page
5. Move your block into a prominent position
6. (Optional) Configure how the block should appear

Hidden items will not appear in the Navigation Progress block until they are visible to students.
