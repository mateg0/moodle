...
class ajax_gs_groups_external extends external_api
{
    /**
    ...
    {   global $PAGE;
        ...
        $template = new \block_groupstats\output\groupstats_form_group($courseid, $groups);
        $renderer = $PAGE->get_renderer('block_groupstats');
        return $renderer->renderGroupStatsFormGroup($template);
    }
    /**
...
class ajax_gs_groupstats_external extends external_api{
    /**
     * @throws coding_exception
     */
    public static function getgroupstats($groupid){
        global $PAGE;
        $template = new \block_groupstats\output\groupstats($groupid);
        $renderer = $PAGE->get_renderer('block_groupstats');
        return $renderer->renderGroupStats($template);
    }

    public static function getgroupstats_parameters()
    {
        return new external_function_parameters(
    ...
    public static function getgroupstats_returns()
    {
        return new external_value(PARAM_RAW, 'The updated template output');
    }
}
