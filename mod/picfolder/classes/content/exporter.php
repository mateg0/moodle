 ...
 */
namespace mod_picfolder\content;
...
class exporter extends abstract_mod_exporter {
    ...
    /**
     * Get the exportable items for mod_picfolder.
     *
    ...
    public function get_exportables(bool $includeuserdata = false): array {
        ...
        $contentitems[]  = new exportable_filearea(
            $this->get_context(),
            $this->get_component(),
            get_string('picfoldercontent', 'mod_picfolder'),

            // The files held in mod_picfolder are stored in the 'content' filearea, under itemid 0.
            'content',
            0,
