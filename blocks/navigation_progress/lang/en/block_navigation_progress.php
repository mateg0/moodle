...
/**
 * Navigation Progress block English language translation
 *
...
$string['navigation_progress:addinstance'] = 'Add a new Navigation Progress block';
$string['navigation_progress:myaddinstance'] = 'Add a Navigation Progress block to My home page';
$string['navigation_progress:overview'] = 'View course overview of Navigation Progress for all students';
$string['navigation_progress:showbar'] = 'Show the bar in the Navigation Progress block';
$string['config_activitiesincluded'] = 'Activities included';
$string['config_activitycompletion'] = 'All activities with completion set';
$string['config_default_title'] = 'Navigation Progress';
...
$string['no_blocks'] = 'No Navigation Progress blocks are set up for your courses.';
...
$string['pluginname'] = 'Navigation Progress';
$string['progress'] = 'Progress';
$string['progressbar'] = 'Navigation Progress';
$string['privacy:metadata'] = 'The Navigation Progress block only displays existing completion data.';
...
$string['why_set_the_title_help'] = '<p>There can be multiple instances of the Navigation Progress block. You may use different Navigation Progress blocks to monitor different sets of activities or resources. For instance you could track progress in assignments in one block and quizzes in another. For this reason you can override the default title and set a more appropriate block title for each instance.</p>';
...
$string['why_use_icons_help'] = '<p>You may wish to add tick and cross icons in the Navigation Progress to make this block more visually accessible for students with colour-blindness.</p><p>It may also make the meaning of the block clearer if you believe colours are not intuitive, either for cultural or personal reasons.</p>';
