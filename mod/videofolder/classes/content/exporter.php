 ...
 */
namespace mod_videofolder\content;
...
class exporter extends abstract_mod_exporter {
    ...
    /**
     * Get the exportable items for mod_videofolder.
     *
    ...
    public function get_exportables(bool $includeuserdata = false): array {
        ...
        $contentitems[]  = new exportable_filearea(
            $this->get_context(),
            $this->get_component(),
            get_string('videofoldercontent', 'mod_videofolder'),

            // The files held in mod_videofolder are stored in the 'content' filearea, under itemid 0.
            'content',
            0,
