...
/**
 * Navigation Progress block runtime configured styles.
 *
...
foreach ($colours as $classname => $stringkey) {
    $colour = get_config('block_navigation_progress', $stringkey) ?:
        get_string('block_navigation_progress', $stringkey);
    $css .= ".block_navigation_progress .progressBarCell.$classname { ";
