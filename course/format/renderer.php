...
//        $o.= html_writer::start_tag('div', array('class' => 'content'));
        $o.= html_writer::start_tag('details', array('class' => 'content', 'open' => ''));
        ...
        $sectionname = $this->output->heading($sectionname, 3, 'sectionname' . $classes, "sectionid-{$section->id}-title");
        $sectionname = html_writer::tag('summary', $sectionname);
